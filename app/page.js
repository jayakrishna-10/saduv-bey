...
export default function Component() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#e6f7ff] to-[#ffffff]">
      ...
      {/* Main Content */}
      <main className="container relative flex min-h-screen items-center justify-center px-4 pt-16">
        <div className="flex flex-col lg:flex-row items-start justify-between w-full py-16 gap-12">
          ...
          <div className="lg:w-1/2 space-y-8">
            <div className="bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-lg p-8">
