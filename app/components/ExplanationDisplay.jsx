// app/components/ExplanationDisplay.jsx
...
const ExplanationDisplay = ({ explanationData, questionText, options, correctAnswer, userAnswer }) => {
      ...
      <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-6 border border-gray-200/50">
        ...
        <div className="p-4 bg-indigo-50 rounded-2xl border border-indigo-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-indigo-900 font-medium mb-1">Correct Answer: {correctAnswer.toUpperCase()}</p>
